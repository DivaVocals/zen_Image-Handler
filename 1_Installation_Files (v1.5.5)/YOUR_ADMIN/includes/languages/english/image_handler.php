...
define('TEXT_INFO_DEFAULT_IMAGE_HELP', 'An original image must be defined. The original image is assumed to be the smallest when medium or large images are entered.');
...
define('TEXT_INFO_CLICK_TO_ADD_MAIN', 'Click to add a new <em>main</em> image to this product');
define('TEXT_INFO_CLICK_TO_ADD_ADDL', 'Click to add a new <em>additional</em> image to this product');
